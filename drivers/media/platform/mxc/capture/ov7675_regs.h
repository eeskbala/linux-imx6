 ...
 */
#ifndef _OV7675_REGS_H
#define _OV7675_REGS_H
...
#define   COM10_PCLK_REV  0x10    /* Invert PCLK */
...
#define REG_MANU	0x67	/* Fix gain control */
#define REG_MANV	0x68	/* Fix gain control */
...
#define OV7675_CLOCK_6MHZ	6000000     /* Added for testing 1-31-13 */
...
struct ov7675_control {
	struct v4l2_queryctrl qc;
	int (*query)(struct i2c_client *c, __s32 *value);
	int (*tweak)(struct i2c_client *c, int value);
};

#endif /* _OV7675_REGS_H */
