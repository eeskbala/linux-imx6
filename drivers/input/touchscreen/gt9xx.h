...
#define GTP_MT                0    // Multi-touch support (Android) 
...
#else
// drw: This data was taken from Config5.cfg
#define CTP_CFG_GROUP1 {\
	0x41,0x20,0x03,0xE0,0x01,0x05,0x35,0x00,0x02,0x3F,\
	0x19,0x0F,0x96,0x46,0x03,0x0A,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x18,0x1A,0x1E,0x14,0x8C,0x2E,0x0E,\
	0x98,0xA5,0xD0,0x07,0x00,0x00,0x00,0x20,0x03,0x3D,\
...
#define GTP_RST_PORT    ts->reset_gpio
#define GTP_INT_PORT    ts->int_gpio
...
//***************************PART3:OTHER define*********************************
#define GTP_DRIVER_VERSION    "V2.1<2014/08/12>"
